...
public class Character{
	...
	public Character(String name, String sex, String type){		
		...
		if(type.equals("Wizard")){
			...
			Rogue item = new Rogue(name, sex, type, blade, magic, lockpicking, stealth, armor,  speech, dodge, dexterity, crit_strike, looter);
			loadout = item.toString();
		}	
		else if(type.equals("Healer")){
			Healer item = new Healer(name, sex, type, blade, magic, lockpicking, stealth, armor,  speech, dodge, dexterity, crit_strike, looter);
			loadout = item.toString();
		}
		else if(type.equals("Archer")){
			Archer item = new Archer(name, sex, type, blade, magic, lockpicking, stealth, armor,  speech, dodge, dexterity, crit_strike, looter);
			loadout = item.toString();
		}	
	...
	public Character(String name, String sex, String type, int blade, int magic, int lockpicking, int stealth, int armor, 
		...
		else if(load.equals("Rogue")){
			Rogue item = new Rogue(name, sex, type, blade, magic, lockpicking, stealth, armor,  speech, dodge, dexterity, crit_strike, looter);
			loadout = item.toString();
		}			
	   else if(load.equals("Healer")){
			Healer item = new Healer(name, sex, type, blade, magic, lockpicking, stealth, armor,  speech, dodge, dexterity, crit_strike, looter);
			loadout = item.toString();
		}
		else if(load.equals("Archer")){
			Archer item = new Archer(name, sex, type, blade, magic, lockpicking, stealth, armor,  speech, dodge, dexterity, crit_strike, looter);
			loadout = item.toString();
		}	
	}
