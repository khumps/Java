/*
 * Calculates the area of a regular polygon given a number of sides and either a radius or side length 
 * using the Polygon class methods
 */
	...
	public static void main(String[] args)
	{
		...
		do
		{
			...
			do
			{
				...
				System.out
						.println("Would you like to calculate the area of another shape? 1(Yes) or 2(No) ");
